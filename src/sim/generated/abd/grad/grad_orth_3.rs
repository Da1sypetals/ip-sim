...
pub fn w_grad_orth_3(a11: f64, a12: f64, a21: f64, a22: f64) -> f64 {
    unsafe {
        grad_orth_3(
...
#[no_mangle]
pub unsafe extern "C" fn grad_orth_3(
    mut a11: libc::c_double,
    mut a12: libc::c_double,
    mut a21: libc::c_double,
    mut a22: libc::c_double,
) -> libc::c_double {
    let mut grad_orth_3_result: libc::c_double = 0.;
    grad_orth_3_result = (a11 * a12 * a21
        + pow(a12, 2 as libc::c_int as libc::c_double) * a22
        + pow(a21, 2 as libc::c_int as libc::c_double) * a22
        + pow(a22, 3 as libc::c_int as libc::c_double)
        - 1.0f64 / 2.0f64
            * a22
            * sqrt(
