...
pub fn w_grad_orth_0(a11: f64, a12: f64, a21: f64, a22: f64) -> f64 {
    unsafe {
        grad_orth_0(
...
#[no_mangle]
pub unsafe extern "C" fn grad_orth_0(
    mut a11: libc::c_double,
    mut a12: libc::c_double,
    mut a21: libc::c_double,
    mut a22: libc::c_double,
) -> libc::c_double {
    let mut grad_orth_0_result: libc::c_double = 0.;
    grad_orth_0_result = (pow(a11, 3 as libc::c_int as libc::c_double)
        + a11 * pow(a12, 2 as libc::c_int as libc::c_double)
        + a11 * pow(a21, 2 as libc::c_int as libc::c_double)
        - 1.0f64 / 2.0f64
            * a11
            * sqrt(
        ...
        - 1.0f64 / 4.0f64
            ...
            * (1.0f64 / 2.0f64
                * (2 as libc::c_int as libc::c_double * a11
                    - 2 as libc::c_int as libc::c_double * a22)
                * (pow(a11, 2 as libc::c_int as libc::c_double)
                    + 2 as libc::c_int as libc::c_double * a11 * a22
                    + pow(a12, 2 as libc::c_int as libc::c_double)
                    - 2 as libc::c_int as libc::c_double * a12 * a21
        ...
        * (if sqrt(
        ...
        + (pow(a11, 3 as libc::c_int as libc::c_double)
            + a11 * pow(a12, 2 as libc::c_int as libc::c_double)
            + a11 * pow(a21, 2 as libc::c_int as libc::c_double)
            + 1.0f64 / 2.0f64
                * a11
