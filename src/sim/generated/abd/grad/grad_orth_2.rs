...
pub fn w_grad_orth_2(a11: f64, a12: f64, a21: f64, a22: f64) -> f64 {
    unsafe {
        grad_orth_2(
...
#[no_mangle]
pub unsafe extern "C" fn grad_orth_2(
    mut a11: libc::c_double,
    mut a12: libc::c_double,
    mut a21: libc::c_double,
    mut a22: libc::c_double,
) -> libc::c_double {
    let mut grad_orth_2_result: libc::c_double = 0.;
    grad_orth_2_result = (pow(a11, 2 as libc::c_int as libc::c_double) * a21
        + a11 * a12 * a22
        + pow(a21, 3 as libc::c_int as libc::c_double)
        + a21 * pow(a22, 2 as libc::c_int as libc::c_double)
        - 1.0f64 / 2.0f64
            * a21
            * sqrt(
        ...
        * (if sqrt(
        ...
        + (pow(a11, 2 as libc::c_int as libc::c_double) * a21
            + a11 * a12 * a22
            + pow(a21, 3 as libc::c_int as libc::c_double)
            + a21 * pow(a22, 2 as libc::c_int as libc::c_double)
            + 1.0f64 / 2.0f64
